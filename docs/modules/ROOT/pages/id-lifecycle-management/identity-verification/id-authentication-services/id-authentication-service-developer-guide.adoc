...
using one ore more authentication types.
* KYC Authentication service- used to request e-KYC for an individul’s
UIN/VID using one ore more authentication types.
...
name with environment - "`Auth-Service-Dev`").
...
https://mosip.github.io/documentation/1.2.0/authentication-service.html#section/Authentication[here].
